...
class Player(Sprites.Sprite):
    ...
    #mendefinisikan metode yang memungkinkan pemain untuk menembak musuh
    ...
    #mendefinisikan metode yang menggerakkan peluru yang ditargetkan pada musuh

    
    # eksekusi peluru player
